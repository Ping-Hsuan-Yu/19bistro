...
var calendar = {
     ...
     */
    solar2lunar: function (y, m, d) { //參數區間西曆1900.1.31~2100.12.31
        //年份限定
        if (y < 1900 || y > 2100) {
            return -1;
        }
     ...
     */
    lunar2solar: function (y, m, d, isLeapMonth) { //參數區間農曆1900.1.1~2100.12.1
        //年份限定
        if (y < 1900 || y > 2100) {
            return -1;
        }
        ...
        if (isLeapMonth && (leapMonth != m)) { // 計算得出的閏月與傳參的月份不同
            return -1;
        }
